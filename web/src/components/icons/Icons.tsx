...
export const SettingsIcon: React.FC<IconProps> = ({ size = 24, color = 'currentColor', className }) => (
  ...
  >
    ...
    <path d="M12 1v6m0 6v6m5.196-15.196l-4.242 4.242m-6 6l-4.242 4.242m15.196 0l-4.242-4.242m-6-6L2.804 2.804" />
  </svg>
);

export const DataIcon: React.FC<IconProps> = ({ size = 24, color = 'currentColor', className }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
